...
<c:set var="opcion" value="${requestScope.opcion}" />
<c:set var="lapsoTiempo" value="${requestScope.lapsoTiempo}" />

<%-- variable para controlar los intervalos de tiempo que maneja la aplicacion --%>
...
function guardarHorario(){
	...
	var url="${pageContext.request.contextPath}/action?accion=gestorTurnos&operacion=doDefinirDescanso&idTurno=${turno.id2}";
