...
<option value="todos" "${grupoSelected2=='todos'?'selected':''}">Todos</option>
<c:forEach items="${listaGrupos}" var="grupo">
<option value="${grupo.id}" "${grupo.id==grupoSelected.id?'selected':''}">${grupo.descripcion}</option>
</c:forEach>
</select>
</td>
<td align="center">Año:&nbsp;
...
<option value="${year}" ${year==yearRequest?'selected':''}>${year}</option>
</c:forEach>
</select>
</td>
...
<option value="actual" ${semanaRequest=='actual'?'selected':''}>Plantilla Actual</option>
</c:if>
<c:forEach items="${listaSemanas}" var="semana">
<option value="${semana}" ${semanaRequest==semana?'selected':''}>${semana}</option>
</c:forEach>
</select>
</td>
<td align="center">
...
<tr>
<td bgcolor="red" align="center" colspan="100" ><font color="white"><b>${grupoIteracion.descripcion}</b></font></td>
</tr>
...
<c:forEach begin="6" end="22" step="1" var="hora">
	<td bgcolor="#B5B5B5" align="center" colspan="4" width="40">
	${hora<=9?'0':''}${hora}
	</td>
</c:forEach>
...
<c:forEach begin="6" end="21" step="1" var="hora">
	<td bgcolor="#EDEDED" align="center" width="25%">00</td>
	<td bgcolor="#EDEDED" align="center" width="25%">05</td>
	<td bgcolor="#EDEDED" align="center" width="25%">10</td>
	<td bgcolor="#EDEDED" align="center" width="25%">15</td>
	<td bgcolor="#EDEDED" align="center" width="25%">20</td>
	<td bgcolor="#EDEDED" align="center" width="25%">25</td>
	<td bgcolor="#EDEDED" align="center" width="25%">30</td>
	<td bgcolor="#EDEDED" align="center" width="25%">35</td>
	<td bgcolor="#EDEDED" align="center" width="25%">40</td>
	<td bgcolor="#EDEDED" align="center" width="25%">45</td>
	<td bgcolor="#EDEDED" align="center" width="25%">50</td>
	<td bgcolor="#EDEDED" align="center" width="25%">55</td>
</c:forEach>
</tr>
...
<c:forEach begin="6" end="21" step="1" var="hora">
	...
	<c:set var="cuartos" value="${fn:split('00,05,10,15,20,25,30,35,40,45,50,55',',')}" /> 
